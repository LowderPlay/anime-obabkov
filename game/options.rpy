...
define config.name = _("Arizona Bebras")
...
define gui.about = _p("""
Старшеклассник Юра оказываются втянутым в фантастический мир, где реальность переплетается с его желанием найти свое призвание. 
Там он встречает девочек-айтишниц, теперь им предстоит сражаться с монстрами, используя уникальные способности, основанные на разработке, тестировании и кибербезопасности.

Каждая битва - это не только борьба за выживание, но и возможность применить свои знания в необычных условиях. Вместе герои должны разгадать тайну появления в этом мире, преодолеть свои страхи и вернуться домой, сохранив дружбу и веру в свои силы.

Проект создан студентами для учебной дисциплины «Основы Проектной Деятельности» как творческая попытка объединить IT-навыки с миром визуальных новелл.

Auto Highlight Ren'Py Module

Kinetic Text Tags Ren'Py Module

- Daniel Westfall <SoDaRa2595@gmail.com>


Hack font - Christopher Simpkins, Bitstream, Inc.

Born2bSporty font - JapanYoshi.

Monocraft font - Idrees Hassan.
...
define config.save_directory = "arizona-1727278886"
