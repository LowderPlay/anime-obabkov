...
define gui.about = _p("""
Четыре студентки-айтишницы оказываются втянутыми в фантастический мир, где реальность переплетается с их профессиональными навыками. Теперь им предстоит сражаться с монстрами, используя уникальные способности, основанные на разработке, тестировании и кибербезопасности.

Каждая битва — это не только борьба за выживание, но и возможность применить свои знания в необычных условиях. Вместе героини должны разгадать тайну появления в этом мире, преодолеть свои страхи и вернуться домой, сохранив дружбу и веру в свои силы.
